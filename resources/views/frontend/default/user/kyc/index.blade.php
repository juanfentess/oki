        ...
        <div class="col-xl-8 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="site-card">
                <div class="site-card-header">
                    <h3 class="title">{{ __('Identity Verification') }}</h3>
                </div>

                <div class="site-card-body">
                    @if($user->kyc == \App\Enums\KYCStatus::Pending->value)
                        <div class="site-badge warnning"> {{ __('Your Identity verification Is Pending') }}</div>
                    @elseif($user->kyc == \App\Enums\KYCStatus::Verified->value)
                        <div class="site-badge success"> {{ __('Your Identity Is Verified') }} </div>
                    @else
